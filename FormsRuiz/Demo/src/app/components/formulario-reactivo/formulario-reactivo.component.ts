...
export class FormularioReactivoComponent {
  ...
  constructor(){
    ...
    let controles: any = {
      correo: new FormControl('carlos@gmail.com', [Validators.required, Validators.pattern(regexCorreo)]),
      contrasena: new FormControl('contra', [Validators.required, Validators.minLength(8)]),
